...
PRED_DIR        = Path(os.path.expanduser("~/v11/swebench-predictions/claude-baseline"))
...
def main():
    ...
    if not api_key:
        sys.exit("Set ANTHROPIC_API_KEY environment variable (source your secrets env file, e.g. ~/.secrets/api-keys.env)")
